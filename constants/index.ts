...
export const villagenameOption = [
  { value: "Dabra", label: "Dabra", jlNo: "07" },
  { value: "Iswarpara", label: "Iswarpara", jlNo: "08" },
  { value: "Bhimpur", label: "Bhimpur", jlNo: "09" },
  { value: "Srirampur", label: "Srirampur", jlNo: "10" },
  { value: "Lalpur", label: "Lalpur", jlNo: "11" },
  { value: "Uttar Jamalpur", label: "Uttar Jamalpur", jlNo: "12" },
  { value: "Srikrishnapur", label: "Srikrishnapur", jlNo: "13" },
  { value: "Purbba Gobindapur", label: "Purbba Gobindapur", jlNo: "14" },
  { value: "Purba Kalikapur", label: "Purba Kalikapur", jlNo: "15" },
  { value: "Dhalpara", label: "Dhalpara", jlNo: "33" },
  { value: "Purbba Thakurpur", label: "Purbba Thakurpur", jlNo: "34" },
  { value: "Kismat Dapt", label: "Kismat Dapt", jlNo: "35" },
  { value: "Chakdapat", label: "Chakdapat", jlNo: "36" },
  { value: "Chapahat", label: "Chapahat", jlNo: "37" },
  { value: "Chak Mohan", label: "Chak Mohan", jlNo: "41" },
  { value: "Basanta", label: "Basanta", jlNo: "42" },
  { value: "Muraripur", label: "Muraripur", jlNo: "43" },
  { value: "Mulahat", label: "Mulahat", jlNo: "44" },
  { value: "Mahishnota", label: "Mahishnota", jlNo: "45" },
  { value: "Jantipur", label: "Jantipur", jlNo: "46" },
  { value: "Purbba Jagannathpur", label: "Purbba Jagannathpur", jlNo: "47" },
  { value: "Laskarpur", label: "Laskarpur", jlNo: "48" },
  { value: "Sarenbari", label: "Sarenbari", jlNo: "58" },
];
...
export const memberFormformSections = [
  ...
  },
  {
    ...
    fields: ["profession", "annualFamilyIncome", "politicalParty", "mouzaIds"],
  },
  {
    title: "Upload Photo",
    fields: ["photo"],
...
export const selectOptions = {
  ...
  politicalParty: ["AITC", "BJP", "CPIM", "INC", "Independent", "Other"],
};
