...
const certificateManagementItems = (baseUrl: string): MenuItemProps[] => [
  ...
  createMenuItem("Land Conversion NOC", ["admin"], undefined, FaRegFileAlt, COLORS.green, [
    ...
    createMenuItem("Make Correction", ["admin"], `${baseUrl}/manage-land-conversion/correction`, FaChevronCircleRight, COLORS.yellow),
...
export const adminMenuItems: MenuItemProps[] = [
  ...
  createMenuItem("Tubewell Management", ["admin"], undefined, MdBuild, COLORS.teal, [
    createMenuItem("Tubewell Register", ["admin"], undefined, FaChevronDown, COLORS.blue, [
      createMenuItem("All Tubewells", ["admin"], `${BASE_URLS.admin}/tubewell/register`, FaChevronCircleRight, COLORS.blue),
      createMenuItem("Add New Tubewell", ["admin"], `${BASE_URLS.admin}/tubewell/register/add`, FaChevronCircleRight, COLORS.green),
    ]),
    createMenuItem("Field Survey", ["admin", "staff"], `${BASE_URLS.admin}/tubewell/survey`, FaChevronCircleRight, COLORS.cyan),
