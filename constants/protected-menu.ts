...
export const publicUserMenuItems: MenuItemProps[] = [
  ...
  createMenuItem("Certificates", ["user"], undefined, MdDescription, COLORS.red, [
    ...
    createMenuItem("Linkage Certificate", ["user"], undefined, FaRegFileAlt, COLORS.blue, [
      createMenuItem("Apply for Certificate", ["user"], `${BASE_URLS.user}/linkage/apply`, FaChevronCircleRight, COLORS.blue),
      createMenuItem("Check Status", ["user"], `${BASE_URLS.user}/linkage/status`, FaChevronCircleRight, COLORS.teal),
    ]),
...
const certificateManagementItems = (baseUrl: string): MenuItemProps[] => [
  ...
  createMenuItem("Linkage Certificate", ["admin"], undefined, FaRegFileAlt, COLORS.blue, [
    ...
    createMenuItem("Output", ["admin"], undefined, FaChevronDown, COLORS.green, [
      createMenuItem("Certificate Printing", ["admin"], `${baseUrl}/manage-linkage/print`, FaChevronCircleRight, COLORS.cyan),
...
const documentGenerationItems = (baseUrl: string): MenuItemProps[] => [
  createMenuItem("Scrutiny Sheets", ["admin"], undefined, FaRegFileAlt, COLORS.indigo, [
    ...
    createMenuItem("Bulk Sheets", ["admin", "agency"], `${baseUrl}/generate/bulk-scrutee-sheet`, FaChevronCircleRight, COLORS.red),
  ]),
  createMenuItem("Agreements & Contracts", ["admin", "agency"], undefined, FaFileContract, COLORS.red, [
    createMenuItem("Agreements", ["admin", "agency"], `${baseUrl}/generate/agrement`, FaChevronCircleRight, COLORS.red),
    createMenuItem("Contractor Prayer", ["admin", "agency"], `${baseUrl}/contractor/print-prayer`, FaChevronCircleRight, COLORS.blue),
  ]),
  createMenuItem("Comparative Statements", ["admin"], `${baseUrl}/generate/comparative-statement`, FaRegFileAlt, COLORS.red),
  createMenuItem("Orders", ["admin", "agency"], undefined, MdAssignment, COLORS.red, [
    createMenuItem("Work Orders", ["admin", "agency"], `${baseUrl}/generate/work-order`, FaChevronCircleRight, COLORS.red),
    createMenuItem("Bulk Work Orders", ["admin"], `${baseUrl}/generate/bulk-work-order`, FaChevronCircleRight, COLORS.red),
    createMenuItem("Supply Orders", ["admin", "agency"], `${baseUrl}/generate/supply-order`, FaChevronCircleRight, COLORS.red),
  ]),
  createMenuItem("Certificates", ["admin", "agency"], undefined, MdDescription, COLORS.red, [
    createMenuItem("Payment Certificates", ["admin", "agency"], `${baseUrl}/generate/payment-certificate`, FaChevronCircleRight, COLORS.red),
    createMenuItem("Completion Certificates", ["admin", "agency"], `${baseUrl}/generate/completation-certificate`, FaChevronCircleRight, COLORS.red),
    createMenuItem("FY Completion Reports", ["admin",], `${baseUrl}/generate/completation-certificate2`, FaChevronCircleRight, COLORS.red),
    createMenuItem("Award of Contract", ["admin", "agency"], `${baseUrl}/generate/generateAOC`, FaChevronCircleRight, COLORS.orange),
  ]),
...
export const employeeMenuItems: MenuItemProps[] = [
  ...
  createMenuItem("Certificate Processing", ["staff"], undefined, MdAssignment, COLORS.red, [
    ...
    createMenuItem("Linkage Certificate", ["staff"], undefined, FaRegFileAlt, COLORS.blue, [
      createMenuItem("Application Lifecycle", ["staff"], undefined, FaChevronDown, COLORS.teal, [
        createMenuItem("New Application", ["staff"], `${BASE_URLS.staff}/manage-linkage/application`, FaChevronCircleRight, COLORS.blue),
        createMenuItem("Document Validation", ["staff"], `${BASE_URLS.staff}/manage-linkage/validate`, FaChevronCircleRight, COLORS.teal),
      ]),
      createMenuItem("Workflow", ["staff"], undefined, FaChevronDown, COLORS.blue, [
        createMenuItem("Ownership Verification", ["staff"], `${BASE_URLS.staff}/manage-linkage/ownership`, FaChevronCircleRight, COLORS.green),
        createMenuItem("Certificate Issuance", ["staff"], `${BASE_URLS.staff}/manage-linkage/issue`, FaChevronCircleRight, COLORS.purple),
      ]),
      createMenuItem("Output", ["staff"], undefined, FaChevronDown, COLORS.green, [
        createMenuItem("Certificate Printing", ["staff"], `${BASE_URLS.staff}/manage-linkage/print`, FaChevronCircleRight, COLORS.cyan),
        createMenuItem("Renewal Process", ["staff"], `${BASE_URLS.staff}/manage-linkage/renew`, FaChevronCircleRight, COLORS.orange),
      ]),
      createMenuItem("Monitoring", ["staff"], undefined, FaChevronDown, COLORS.red, [
        createMenuItem("Dispute Resolution", ["staff"], `${BASE_URLS.staff}/manage-linkage/disputes`, FaChevronCircleRight, COLORS.red),
      ]),
    ]),
  ...
  createMenuItem("Community Services", ["staff"], undefined, FaTruck, COLORS.blue, [
    createMenuItem("Village Management", ["staff"], undefined, MdHolidayVillage, COLORS.cyan, [
      ...
      createMenuItem("Village Report", ["staff"], `${BASE_URLS.staff}/village/reports`, FaChevronCircleRight, COLORS.cyan),
    ]),
  ...
  createMenuItem("Personal & Development", ["staff"], undefined, MdPersonAdd, COLORS.purple, [
    createMenuItem("Leave Management", ["staff"], `${BASE_URLS.staff}/leave`, FaChevronCircleRight, COLORS.pink, [
