    ...
    <div className="min-h-screen bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-6 rounded-2xl border shadow-sm">
          <div>
            ...
            <p className="text-slate-500 mt-2 max-w-2xl">
              Register and manage mechanics for tubewell maintenance. 
              Keep track of contact information, availability, and payment details.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            { label: "Total Registered Mistris", value: total, color: "slate", icon: Users },
            { label: "Currently Active", value: activeCount, color: "emerald", icon: Users },
          ].map((stat, i) => (
        ...
        <div className="bg-white rounded-2xl border shadow-sm overflow-hidden">
          {mistris.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900">No Mistris Found</h3>
              <p className="text-slate-500 mt-2 max-w-xs mx-auto">
                No mechanics have been registered yet. Start by adding your first mistri.
              </p>
