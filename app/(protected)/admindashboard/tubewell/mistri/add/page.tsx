      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Register a new mechanic in the system.
            </p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the personal and contact details of the mechanic.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Full address of the mistri"
                            rows={3}
                            disabled={isPending}
                            {...field}
                          />
