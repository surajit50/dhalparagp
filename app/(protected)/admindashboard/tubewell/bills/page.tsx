...
export default async function BillsPage() {
  ...
  const formattedAmount = `₹${new Intl.NumberFormat("en-IN", { maximumFractionDigits: 0 }).format(totalAmount)}`;
          ...
          {bills.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-slate-500 mt-2 max-w-xs mx-auto">
                No bills have been generated yet. Completed work orders will
                appear here once billed.
              </p>
