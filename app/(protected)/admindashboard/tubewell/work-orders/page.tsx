  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        <PageHeader
          title="Work Orders"
          description="Manage and monitor technical assignments. Issue new orders to mistris and track material utilization."
          icon="Settings2"
        >
          <Button
            asChild
        ...
        {/* TABLE SECTION */}
        {orders.length === 0 ? (
          <div className="bg-white rounded-3xl border shadow-sm flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-slate-500 mt-2 max-w-xs mx-auto">
              Your work order history is currently empty. Issue your first
