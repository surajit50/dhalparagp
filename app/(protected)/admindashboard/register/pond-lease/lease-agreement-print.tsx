...
export function LeaseAgreementPrint({ lease, trigger }: LeaseAgreementPrintProps) {
  ...
  if (years > 0 && months > 0) {
    displayLeasePeriod = `${years} বছর ${months} মাস (${years} Year${years > 1 ? 's' : ''} ${months} Month${months > 1 ? 's' : ''})`;
  } else if (years > 0) {
    displayLeasePeriod = `${years} বছর (${years} Year${years > 1 ? 's' : ''})`;
  } else if (months > 0) {
    displayLeasePeriod = `${months} মাস (${months} Month${months > 1 ? 's' : ''})`;
  } else {
    displayLeasePeriod = `1 বছর (1 Year)`; // fallback
  }
  ...
  // Total lease amount (new field)
  const totalLeaseAmount = lease?.totalAmount || 0;
  const yearlyLeaseAmount = lease?.leaseAmountYearly || 0;
            ...
            <div className="content-layer">
              ...
              <div className="header-wrap">
                ...
                <p className="gp-address-text">
                  গ্রাম - কিসমতদাপাট, ডাকঘর - ত্রিমোহিনী, ব্লক ও থানা - {blockname || "হিলি"}, জেলা -[...]
                </p>
              ...
              <div className="parties-grid">
                <div className="party-card">
                  ...
                  <div className="party-card-body">
                    <strong>৩ নং ধালপাড়া গ্রাম পঞ্চায়েত</strong>, পক্ষে প্রধান / কার্যনির্বাহী [...]
                    {(langMode === "bilingual" || langMode === "english") && (
              ...
              <div className="preamble-box">
                {(langMode === "bilingual" || langMode === "bengali") && (
                  <p>
                    অদ্য <strong>{agreementDate}</strong> তারিখে উভয় পক্ষের পারস্পরিক সম্মতিক্রমে ৩ নং ধ[...]
                  </p>
                )}
                {(langMode === "bilingual" || langMode === "english") && (
              ...
              <div className="matrix-2col">
                ...
                <div className="matrix-col">
                  <div className="matrix-col-header">
                    <span>२. আর্থিক বিবরণ ও মেয়াদ</span>
                  ...
                  <table className="matrix-table">
                    <tbody>
                      ...
                      <tr>
                        <td className="lbl">মোট চুক্তি মূল্য (Total Lease Amount)</td>
                        <td className="val font-bold" style={{ color: "#1e3a8a" }}>
                          {currencyFormatter.format(totalLeaseAmount || 0)}
                        </td>
                      </tr>
                      <tr>
              ...
              <div className="terms-section">
                <div className="terms-header">
                  <span>३. চুক্তিপত্রের সাধারণ ও বিশেষ শর্তাবলী</span>
