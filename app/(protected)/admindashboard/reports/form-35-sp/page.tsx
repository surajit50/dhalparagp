...
export default async function Form35SPPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 w-full">
      ...
      <Form35Table
        title="Silpa & Parikathamo"
        groups={[
          { label: "Silpa", columnKey: "silpa" },
          { label: "Parikathamo", columnKey: "parikathamo" }
        ]}
