...
export default async function Form35NoSUPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 w-full">
      ...
      <Form35Table
        title="Nari o Sishu Unnayan & Samajkalyan"
        groups={[
          { label: "Nari o Sishu", columnKey: "nariOSishuUnnoyan" },
          { label: "Samajkalyan", columnKey: "samajkalyan" }
        ]}
