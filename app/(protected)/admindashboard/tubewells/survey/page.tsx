...
import { TubewellSurveyForm } from "@/components/tubewells/TubewellSurveyForm";

export const metadata = {
  title: "Tubewell Field Survey | Dhalpara GP",
  description: "Mobile-optimized tubewell survey form for field data collection.",
};

export default function TubewellSurveyPage() {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6 border-b border-border/40">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30 ring-1 ring-blue-500/20">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-muted-foreground mt-1 flex items-center gap-2">
                ...
                Mobile-friendly entry — GPS, photo, and details
              </p>
            </div>
          </div>
        </div>
